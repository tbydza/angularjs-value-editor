 ...
 */
export default class AcceptableValueEditorLocalizationsServiceProvider extends AbstractValueEditorLocalizationProvider<AcceptableValueEditorLocalizations> {

...
})(window, function(__WEBPACK_EXTERNAL_MODULE__0__, __WEBPACK_EXTERNAL_MODULE__4__, __WEBPACK_EXTERNAL_MODULE__24__, __WEBPACK_EXTERNAL_MODULE__44__, __WEBPACK_EXTERNAL_MODULE__47__, __WEBPACK_EXTERNAL_MODULE__48__, __WEBPACK_EXTERNAL_MODULE__66__, __WEBPACK_EXTERNAL_MODULE__67__, __WEBPACK_EXTERNAL_MODULE__81__, __WEBPACK_EXTERNAL_MODULE__142__) {
...
var kp_value_editor_aliases_service_1 = __webpack_require__(17);
/**
 * @ngdoc provider
...
var AbstractValueEditorConfigurationProvider = /*#__PURE__*/function () {
  function AbstractValueEditorConfigurationProvider(kpValueEditorAliasesServiceProvider, defaultConfiguration) {
    _classCallCheck(this, AbstractValueEditorConfigurationProvider);

    this.kpValueEditorAliasesServiceProvider = kpValueEditorAliasesServiceProvider;
    this.defaultConfiguration = defaultConfiguration;
    this.currentConfiguration = new Map();
    this.currentConfiguration.set(kp_value_editor_aliases_service_1.DEFAULT_ALIAS, defaultConfiguration);
  }
  ...
  _createClass(AbstractValueEditorConfigurationProvider, [{
    ...
    value: function forAlias(alias) {
      ...
      if (!this.kpValueEditorAliasesServiceProvider.isAlias(alias)) {
        fallbackedAlias = kp_value_editor_aliases_service_1.DEFAULT_ALIAS;
      }
    ...
    value: function getConfiguration() {
      return this.getAliasedConfiguration(kp_value_editor_aliases_service_1.DEFAULT_ALIAS);
    }
  }, {
    key: "setConfiguration",
    value: function setConfiguration(configuration) {
      return this.setAliasedConfiguration(kp_value_editor_aliases_service_1.DEFAULT_ALIAS, configuration);
    }
  }, {
    key: "$get",
    value: function $get() {
...
var kp_value_editor_component_1 = __webpack_require__(8);

var AbstractValueEditorComponent = function AbstractValueEditorComponent() {
  _classCallCheck(this, AbstractValueEditorComponent);
...
exports.default = AbstractValueEditorComponent;
...
var ng_model_connector_1 = __webpack_require__(11);

var angular = __webpack_require__(4);

var abstract_value_editor_configuration_provider_1 = __webpack_require__(1);

var equals_1 = __webpack_require__(9);
...
var AbstractValueEditorComponentController = /*#__PURE__*/function (_ng_model_connector_) {
  _inherits(AbstractValueEditorComponentController, _ng_model_connector_);

  var _super = _createSuper(AbstractValueEditorComponentController);

  function AbstractValueEditorComponentController(configurationService, localizationService) {
    var _this;

    _classCallCheck(this, AbstractValueEditorComponentController);
  ...
  _createClass(AbstractValueEditorComponentController, [{
    key: "$onInit",
    value: function $onInit() {
      _get(_getPrototypeOf(AbstractValueEditorComponentController.prototype), "$onInit", this).call(this);
    ...
    value: function $postLink() {
      ...
      if (!equals_1.customEquals(this.options, this.configurationService.forAlias(this.valueEditorController.type).getConfiguration())) {
        this.onOptionsChange(this.options, this.configurationService.forAlias(this.valueEditorController.type).getConfiguration(), equals_1.whichPropertiesAreNotEqual(this.options, this.configurationService.forAlias(this.valueEditorController.type).getConfiguration()));
      }
    ...
    key: "processNewOptions",
    value: function processNewOptions(newOptions) {
      var options = Object.assign({}, this.configurationService.forAlias(this.valueEditorController.type).getConfiguration(), newOptions);
    ...
    key: "emptyAsNullParser",
    value: function emptyAsNullParser(modelValue) {
      if (!this.options.emptyAsNull) {
        return modelValue;
      }

      if (this.options.customEmptyAsNullCheck) {
        var isEmpty = this.valueEditorController.$element.injector().invoke(this.options.customEmptyAsNullCheck, this, {
          $value: modelValue
        });
      ...
      if (equals_1.customEquals(modelValue, this.emptyModel)) {
        return null;
      }
    ...
    key: "emptyAsNullFormatter",
    value: function emptyAsNullFormatter(modelValue) {
      if (!this.options.emptyAsNull) {
        return modelValue;
      }
  ...
  return AbstractValueEditorComponentController;
}(ng_model_connector_1.default);

AbstractValueEditorComponentController.$inject = ['emptyConfigurationService'];

__decorate([bind_decorator_1.default], AbstractValueEditorComponentController.prototype, "emptyAsNullParser", null);

__decorate([bind_decorator_1.default], AbstractValueEditorComponentController.prototype, "emptyAsNullFormatter", null);

exports.default = AbstractValueEditorComponentController;

var EmptyConfigurationService = /*#__PURE__*/function (_abstract_value_edito) {
  EmptyConfigurationService.$inject = ["kpValueEditorAliasesServiceProvider"];
  ...
  /*@ngInject*/
  function EmptyConfigurationService(kpValueEditorAliasesServiceProvider) {
    _classCallCheck(this, EmptyConfigurationService);

    return _super2.call(this, kpValueEditorAliasesServiceProvider, {});
  }
...
var abstract_value_editor_component_controller_1 = __webpack_require__(3);

var uuid_generator_1 = __webpack_require__(10);
/**
...
}(abstract_value_editor_component_controller_1.default);
...
var kp_universal_form_component_1 = __webpack_require__(19);

var kp_value_editor_force_settings_component_1 = __webpack_require__(12);

var KpValueEditorComponentController = /*#__PURE__*/function (_ng_model_connector_) {
  KpValueEditorComponentController.$inject = ["kpValueEditorAliasesService", "kpValueEditorConfigurationService", "$element", "$templateCache", "kpValueEditorRegistrationService", "$document"];
  ...
  /*@ngInject*/
  function KpValueEditorComponentController(kpValueEditorAliasesService, kpValueEditorConfigurationService, $element, $templateCache, kpValueEditorRegistrationService, $document) {
    var _this;

    _classCallCheck(this, KpValueEditorComponentController);

    _this = _super.call(this);
    _this.kpValueEditorAliasesService = kpValueEditorAliasesService;
    _this.$element = $element;
    _this.$templateCache = $templateCache;
    _this.kpValueEditorRegistrationService = kpValueEditorRegistrationService;
  ...
  _createClass(KpValueEditorComponentController, [{
    ...
    key: "updateTemplate",
    value: function updateTemplate() {
      var selector = this.kpValueEditorRegistrationService.getSelectorForType(this.resolveAlias());
      this.templateUpdated = true;
      this.$templateCache.remove(this.templateUrl);
      var newTemplateName = "".concat(KpValueEditorComponentController.TEMPLATE_PREFIX, "_").concat(this.uuid, "_").concat(new Date().valueOf());
      var element = this.$document[0].createElement(selector);
...
KpValueEditorComponentController.TEMPLATE_PREFIX = '';
/**
 * @ngdoc component
 * @name kpValueEditor
 * @module angularjs-value-editor
...
var KpValueEditorComponent = function KpValueEditorComponent() {
  ...
  this.require = {
    ngModelController: 'ngModel',
    formController: '?^^form',
    universalFormController: "?^^".concat(kp_universal_form_component_1.default.componentName),
    forceSettingsController: "?^^".concat(kp_value_editor_force_settings_component_1.default.componentName)
  };
  this.bindings = {
    type: '<',
    editorId: '<?',
...
var kp_value_editor_force_setting_component_1 = __webpack_require__(20);

exports.ALL_TYPES = 'ALL';

var OptionsAndValidations = function OptionsAndValidations(options, validations, strategy) {
...
var KpValueEditorForceSettingsComponentController = /*#__PURE__*/function () {
  function KpValueEditorForceSettingsComponentController() {
    _classCallCheck(this, KpValueEditorForceSettingsComponentController);

    this.settings = new Map();
  }

  _createClass(KpValueEditorForceSettingsComponentController, [{
    key: "$onDestroy",
    value: function $onDestroy() {
      this.settings.clear();
    ...
    value: function getValidationsForTypeOrEmpty(type) {
      var _a, _b;

      return (_b = (_a = this.settings.get(type)) === null || _a === void 0 ? void 0 : _a.validations) !== null && _b !== void 0 ? _b : {};
    }
  }, {
    key: "mergeOptionsForType",
    value: function mergeOptionsForType(type, options) {
      var _a, _b;

      var mergeStrategy = (_b = (_a = this.settings.get(type)) === null || _a === void 0 ? void 0 : _a.strategy) !== null && _b !== void 0 ? _b : kp_value_editor_force_setting_component_1.DEFAULT_MERGE_STRATEGY;
      var mergeFunction = mergeStrategy === 'merge' ? angular.merge : Object.assign;
      return mergeFunction({}, options, this.getOptionsForTypeOrEmpty(type, mergeStrategy));
    }
  }, {
    key: "addNewSettings",
    value: function addNewSettings(type, options, validations, strategy) {
      this.settings.set(type, new OptionsAndValidations(options, validations, strategy));
    }
  }, {
    key: "getOptionsForTypeOrEmpty",
    value: function getOptionsForTypeOrEmpty(type, mergeStrategy) {
      var _a, _b, _c, _d;

      var mergeFunction = mergeStrategy === 'merge' ? angular.merge : Object.assign;
      return mergeFunction({}, (_b = (_a = this.settings.get(exports.ALL_TYPES)) === null || _a === void 0 ? void 0 : _a.options) !== null && _b !== void 0 ? _b : {}, (_d = (_c = this.settings.get(type)) === null || _c === void 0 ? void 0 : _c.options) !== null && _d !== void 0 ? _d : {});
    }
  }]);

  return KpValueEditorForceSettingsComponentController;
}();

exports.KpValueEditorForceSettingsComponentController = KpValueEditorForceSettingsComponentController;
/**
 * @ngdoc component
...
var KpValueEditorForceSettingsComponent = function KpValueEditorForceSettingsComponent() {
  _classCallCheck(this, KpValueEditorForceSettingsComponent);

  this.transclude = true;
  this.template = '<ng-transclude></ng-transclude>';
  this.controller = KpValueEditorForceSettingsComponentController;
};

exports.default = KpValueEditorForceSettingsComponent;
KpValueEditorForceSettingsComponent.componentName = 'kpValueEditorForceSettings';
...
var TextValueEditorComponentController = /*#__PURE__*/function (_abstract_value_edito) {
  TextValueEditorComponentController.$inject = ["textValueEditorConfigurationService", "textValueEditorLocalizationsService"];
  ...
  /*@ngInject*/
  function TextValueEditorComponentController(textValueEditorConfigurationService, textValueEditorLocalizationsService) {
    var _this;
  ...
  _createClass(TextValueEditorComponentController, [{
    key: "$onInit",
    value: function $onInit() {
      _get(_getPrototypeOf(TextValueEditorComponentController.prototype), "$onInit", this).call(this);
    ...
    key: "trim",
    value: function trim(modelValue) {
...
__decorate([bind_decorator_1.default], TextValueEditorComponentController.prototype, "trim", null);
...
var TextValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(TextValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(TextValueEditorComponent);

  function TextValueEditorComponent() {
    var _this4;

    _classCallCheck(this, TextValueEditorComponent);

    _this4 = _super2.apply(this, arguments);
    _this4.templateUrl = __webpack_require__(83);
    _this4.controller = TextValueEditorComponentController;
    return _this4;
  }

  return TextValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = TextValueEditorComponent;
TextValueEditorComponent.componentName = 'textValueEditor';
TextValueEditorComponent.valueEditorType = 'text';
...
exports.NumberRangeValueEditorComponentController = exports.EMPTY_MODEL = void 0;
...
var NumberRangeValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(NumberRangeValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(NumberRangeValueEditorComponent);

  function NumberRangeValueEditorComponent() {
    var _this3;

    _classCallCheck(this, NumberRangeValueEditorComponent);

    _this3 = _super2.apply(this, arguments);
    _this3.templateUrl = __webpack_require__(114);
    _this3.controller = NumberRangeValueEditorComponentController;
    return _this3;
  }

  return NumberRangeValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = NumberRangeValueEditorComponent;
NumberRangeValueEditorComponent.componentName = 'numberRangeValueEditor';
NumberRangeValueEditorComponent.valueEditorType = 'number-range';
...
exports.default = angularjs_register_1.default('angularjs-value-editor.aliases').provider(kp_value_editor_aliases_service_1.KpValueEditorAliasesServiceProviderImpl.providerName, kp_value_editor_aliases_service_1.KpValueEditorAliasesServiceProviderImpl).name();
...
exports.KpValueEditorAliasesServiceProviderImpl = exports.DEFAULT_ALIAS = void 0;
exports.DEFAULT_ALIAS = 'DEFAULT';

var KpValueEditorAliasesServiceProviderImpl = /*#__PURE__*/function () {
  KpValueEditorAliasesServiceProviderImpl.$inject = ["$injector", "$logProvider", "$windowProvider"];

  /*@ngInject*/
  function KpValueEditorAliasesServiceProviderImpl($injector, $logProvider, $windowProvider) {
    _classCallCheck(this, KpValueEditorAliasesServiceProviderImpl);
  ...
  _createClass(KpValueEditorAliasesServiceProviderImpl, [{
    key: "addAlias",
  ...
  return KpValueEditorAliasesServiceProviderImpl;
}();

exports.KpValueEditorAliasesServiceProviderImpl = KpValueEditorAliasesServiceProviderImpl;
KpValueEditorAliasesServiceProviderImpl.providerName = 'kpValueEditorAliasesService';
...
var injectables_1 = __webpack_require__(21);
...
var AcceptableValueEditorComponentController = /*#__PURE__*/function (_abstract_template_va) {
  AcceptableValueEditorComponentController.$inject = ["$interpolate", "$templateCache", "acceptableValueEditorLocalizationsService", "acceptableValueEditorConfigurationService", "$element", "$injector"];
  ...
  /*@ngInject*/
  function AcceptableValueEditorComponentController($interpolate, $templateCache, acceptableValueEditorLocalizationsService, acceptableValueEditorConfigurationService, $element, $injector) {
    var _this;

    _classCallCheck(this, AcceptableValueEditorComponentController);

    _this = _super.call(this, AcceptableValueEditorComponentController.INLINE_TEMPLATE_URL, TEMPLATE_NAME_PREFIX, $interpolate, $templateCache, acceptableValueEditorConfigurationService, acceptableValueEditorLocalizationsService);
  ...
  _createClass(AcceptableValueEditorComponentController, [{
    ...
    value: function getAcceptableValuesForCheckboxes() {
      ...
      if (this.options.selectedFirst) {
        ...
        if (injectables_1.isInjectableOrFunction(this.options.sortComparator)) {
    ...
    value: function getAcceptableValuesForUiSelect() {
      ...
      if (!this.options.multiselectable && this.options.allowSelectNull && !((_a = this.valueEditorController.validations) === null || _a === void 0 ? void 0 : _a.required)) {
    ...
    value: function uiSelectComparator(e1, e2) {
      try {
        return injectables_1.isInjectableOrFunction(this.options.sortComparator) && e1 !== null && e2 !== null ? this.sortComparator(e1.value, e2.value) : 0;
      } catch (e) {
    ...
    value: function selectItem(item) {
      ...
      if (this.equalityComparator(item, this.model) && this.options.allowSelectNull && !((_a = this.valueEditorController.validations) === null || _a === void 0 ? void 0 : _a.required)) {
        this.model = null;
      } else {
        this.model = item;
      }
    ...
    value: function onOptionsChange(newOptions, oldOptions, whichOptionIsChanged) {
      if (whichOptionIsChanged.optionsTemplate || whichOptionIsChanged.searchable || whichOptionIsChanged.multiselectable || whichOptionIsChanged.sortComparator || whichOptionIsChanged.reorderable || whichOptionIsChanged.acceptableValues || whichOptionIsChanged.switchToBlockModeThreshold || whichOptionIsChanged.selectedFirst) {
    ...
    value: function getTemplateModel() {
      return {
        ...
        uuid: this.uuid,
        sort: injectables_1.isInjectableOrFunction(this.options.sortComparator),
    ...
    value: function includes(array, item) {
      ...
      return Array.isArray(array) && array.some(function (value) {
        return _this4.equalityComparator(value, item);
      });
    }
  }, {
    key: "getMoreCount",
    ...
    value: function getTemplateUrl() {
      var isBlock = this.options.acceptableValues.length > this.options.switchToBlockModeThreshold;
    ...
    set: function set(value) {
      ...
      if (this.options.multiselectable && this.options.sortModel && Array.isArray(value)) {
        _set(_getPrototypeOf(AcceptableValueEditorComponentController.prototype), "model", value.sort(this.sortComparator), this, true);
      } else {
        if (this.options.modelAsArray && !Array.isArray(value)) {
          if (value === null) {
            _set(_getPrototypeOf(AcceptableValueEditorComponentController.prototype), "model", [], this, true);
          } else {
    ...
    get: function get() {
      ...
      if (injectables_1.isInjectableOrFunction(this.options.sortComparator)) {
        return function ($element1, $element2) {
          return _this5.$injector.invoke(_this5.options.sortComparator, null, {
            $element1: $element1,
            $element2: $element2
          });
        };
    ...
    get: function get() {
      ...
      var comparator = this.acceptableValueEditorConfigurationService.getDefaults().equalityComparator;

      if (injectables_1.isInjectableOrFunction(this.options.equalityComparator)) {
        comparator = this.options.equalityComparator;
      }

      return function ($element1, $element2) {
        return _this6.$injector.invoke(comparator, null, {
          $element1: $element1,
          $element2: $element2
        });
      };
...
AcceptableValueEditorComponentController.INLINE_TEMPLATE_URL = __webpack_require__(53);
AcceptableValueEditorComponentController.MULTIPLE_BLOCK_TEMPLATE_URL = __webpack_require__(54);
AcceptableValueEditorComponentController.SINGLE_BLOCK_TEMPLATE_URL = __webpack_require__(55);
/**
 * @ngdoc component
...
var AcceptableValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito) {
  _inherits(AcceptableValueEditorComponent, _abstract_value_edito);

  var _super2 = _createSuper(AcceptableValueEditorComponent);

  function AcceptableValueEditorComponent() {
    var _this7;

    _classCallCheck(this, AcceptableValueEditorComponent);

    _this7 = _super2.apply(this, arguments);
    _this7.template = abstract_template_value_editor_1.default.COMPONENT_TEMPLATE;
    _this7.controller = AcceptableValueEditorComponentController;
    return _this7;
  }

  return AcceptableValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = AcceptableValueEditorComponent;
AcceptableValueEditorComponent.componentName = 'acceptableValueEditor';
AcceptableValueEditorComponent.valueEditorType = 'acceptable';
...
KpUniversalFormComponentController.TEMPLATE_URL = __webpack_require__(52);
/**
 * @ngdoc component
...
exports.DEFAULT_MERGE_STRATEGY = exports.KpValueEditorForceSettingComponentController = void 0;

var kp_value_editor_force_settings_component_1 = __webpack_require__(12);

var KpValueEditorForceSettingComponentController = /*#__PURE__*/function () {
  KpValueEditorForceSettingComponentController.$inject = ["$log"];

  /*@ngInject*/
  function KpValueEditorForceSettingComponentController($log) {
    _classCallCheck(this, KpValueEditorForceSettingComponentController);
  ...
  _createClass(KpValueEditorForceSettingComponentController, [{
    ...
    value: function $onInit() {
      ...
      this.kpValueEditorForceSettingsComponentController.addNewSettings((_a = this.type) !== null && _a !== void 0 ? _a : kp_value_editor_force_settings_component_1.ALL_TYPES, this.options, this.validations, (_b = this.strategy) !== null && _b !== void 0 ? _b : exports.DEFAULT_MERGE_STRATEGY);
    }
  }]);

  return KpValueEditorForceSettingComponentController;
}();

exports.KpValueEditorForceSettingComponentController = KpValueEditorForceSettingComponentController;
/**
 * @ngdoc component
...
var KpValueEditorForceSettingComponent = function KpValueEditorForceSettingComponent() {
  _classCallCheck(this, KpValueEditorForceSettingComponent);
  ...
  this.priority = 20;
  this.controller = KpValueEditorForceSettingComponentController;
};

exports.default = KpValueEditorForceSettingComponent;
KpValueEditorForceSettingComponent.componentName = 'kpValueEditorForceSetting';
/**
 * @ngdoc constant
...
exports.DEFAULT_MERGE_STRATEGY = 'overwrite';
...
exports.isInjectableOrFunction = exports.isInjectable = void 0;

var angular = __webpack_require__(4);

function isInjectable(injectable) {
  ...
  if (Array.isArray(injectable) && injectable.length > 0) {
    var fce = injectable[injectable.length - 1]; // function should be last element
...
function isInjectableOrFunction(value) {
  return angular.isFunction(value) || isInjectable(value);
}

exports.isInjectableOrFunction = isInjectableOrFunction;
...
__decorate([bind_decorator_1.default], BooleanValueEditorComponentController.prototype, "formatToCustomValue", null);

__decorate([bind_decorator_1.default], BooleanValueEditorComponentController.prototype, "parseFromCustomValue", null);

__decorate([bind_decorator_1.default], BooleanValueEditorComponentController.prototype, "adjustIndeterminateState", null);
...
var BooleanValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(BooleanValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(BooleanValueEditorComponent);

  function BooleanValueEditorComponent() {
    var _this;

    _classCallCheck(this, BooleanValueEditorComponent);

    _this = _super2.apply(this, arguments);
    _this.templateUrl = __webpack_require__(64);
    _this.controller = BooleanValueEditorComponentController;
    return _this;
  }

  return BooleanValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = BooleanValueEditorComponent;
BooleanValueEditorComponent.componentName = 'booleanValueEditor';
BooleanValueEditorComponent.valueEditorType = 'boolean';
...
var luxon_1 = __webpack_require__(24);
...
var DateValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(DateValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(DateValueEditorComponent);

  function DateValueEditorComponent() {
    var _this;

    _classCallCheck(this, DateValueEditorComponent);

    _this = _super2.apply(this, arguments);
    _this.templateUrl = __webpack_require__(68);
    _this.controller = DateValueEditorComponentController;
    return _this;
  }

  return DateValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = DateValueEditorComponent;
DateValueEditorComponent.componentName = 'dateValueEditor';
DateValueEditorComponent.valueEditorType = 'date';
...
var HiddenValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(HiddenValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(HiddenValueEditorComponent);

  function HiddenValueEditorComponent() {
    var _this;

    _classCallCheck(this, HiddenValueEditorComponent);

    _this = _super2.apply(this, arguments);
    _this.templateUrl = __webpack_require__(71);
    _this.controller = HiddenValueEditorComponentController;
    return _this;
  }

  return HiddenValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = HiddenValueEditorComponent;
HiddenValueEditorComponent.componentName = 'hiddenValueEditor';
HiddenValueEditorComponent.valueEditorType = 'hidden';
...
var HtmlValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(HtmlValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(HtmlValueEditorComponent);

  function HtmlValueEditorComponent() {
    var _this3;

    _classCallCheck(this, HtmlValueEditorComponent);

    _this3 = _super2.apply(this, arguments);
    _this3.templateUrl = __webpack_require__(74);
    _this3.controller = HtmlValueEditorComponentController;
    return _this3;
  }

  return HtmlValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = HtmlValueEditorComponent;
HtmlValueEditorComponent.componentName = 'htmlValueEditor';
HtmlValueEditorComponent.valueEditorType = 'html';
...
var NumberValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(NumberValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(NumberValueEditorComponent);

  function NumberValueEditorComponent() {
    var _this;

    _classCallCheck(this, NumberValueEditorComponent);

    _this = _super2.apply(this, arguments);
    _this.templateUrl = __webpack_require__(78);
    _this.controller = NumberValueEditorComponentController;
    return _this;
  }

  return NumberValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = NumberValueEditorComponent;
NumberValueEditorComponent.componentName = 'numberValueEditor';
NumberValueEditorComponent.valueEditorType = 'number';
...
var YearValueEditorComponentController = /*#__PURE__*/function (_abstract_value_edito) {
  ...
  _createClass(YearValueEditorComponentController, [{
    ...
    key: "modelParser",
    value: function modelParser(isoDate) {
      if (isoDate) {
    ...
    key: "modelFormatter",
    value: function modelFormatter(year) {
      if (year) {
...
__decorate([bind_decorator_1.default], YearValueEditorComponentController.prototype, "modelParser", null);

__decorate([bind_decorator_1.default], YearValueEditorComponentController.prototype, "modelFormatter", null);
...
var YearValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(YearValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(YearValueEditorComponent);

  function YearValueEditorComponent() {
    var _this;

    _classCallCheck(this, YearValueEditorComponent);

    _this = _super2.apply(this, arguments);
    _this.templateUrl = __webpack_require__(88);
    _this.controller = YearValueEditorComponentController;
    return _this;
  }

  return YearValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = YearValueEditorComponent;
YearValueEditorComponent.componentName = 'yearValueEditor';
YearValueEditorComponent.valueEditorType = 'year';
...
var CardNumberValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(CardNumberValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(CardNumberValueEditorComponent);

  function CardNumberValueEditorComponent() {
    var _this3;

    _classCallCheck(this, CardNumberValueEditorComponent);

    _this3 = _super2.apply(this, arguments);
    _this3.templateUrl = __webpack_require__(93);
    _this3.controller = CardNumberValueEditorComponentController;
    return _this3;
  }

  return CardNumberValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = CardNumberValueEditorComponent;
CardNumberValueEditorComponent.componentName = 'cardNumberValueEditor';
CardNumberValueEditorComponent.valueEditorType = 'card-number';
...
var AutocompleteValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(AutocompleteValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(AutocompleteValueEditorComponent);

  function AutocompleteValueEditorComponent() {
    var _this5;

    _classCallCheck(this, AutocompleteValueEditorComponent);

    _this5 = _super2.apply(this, arguments);
    _this5.templateUrl = __webpack_require__(96);
    _this5.controller = AutocompleteValueEditorComponentController;
    return _this5;
  }

  return AutocompleteValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = AutocompleteValueEditorComponent;
AutocompleteValueEditorComponent.componentName = 'autocompleteValueEditor';
AutocompleteValueEditorComponent.valueEditorType = 'autocomplete';
...
var PasswordValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(PasswordValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(PasswordValueEditorComponent);

  function PasswordValueEditorComponent() {
    var _this2;

    _classCallCheck(this, PasswordValueEditorComponent);

    _this2 = _super2.apply(this, arguments);
    _this2.templateUrl = __webpack_require__(100);
    _this2.controller = PasswordValueEditorComponentController;
    return _this2;
  }

  return PasswordValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = PasswordValueEditorComponent;
PasswordValueEditorComponent.componentName = 'passwordValueEditor';
PasswordValueEditorComponent.valueEditorType = 'password';
...
var SignatureValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(SignatureValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(SignatureValueEditorComponent);

  function SignatureValueEditorComponent() {
    var _this3;

    _classCallCheck(this, SignatureValueEditorComponent);

    _this3 = _super2.apply(this, arguments);
    _this3.templateUrl = __webpack_require__(105);
    _this3.controller = SignatureValueEditorComponentController;
    return _this3;
  }

  return SignatureValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = SignatureValueEditorComponent;
SignatureValueEditorComponent.componentName = 'signatureValueEditor';
SignatureValueEditorComponent.valueEditorType = 'signature';
...
var AccessNumberValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(AccessNumberValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(AccessNumberValueEditorComponent);

  function AccessNumberValueEditorComponent() {
    var _this3;

    _classCallCheck(this, AccessNumberValueEditorComponent);

    _this3 = _super2.apply(this, arguments);
    _this3.templateUrl = __webpack_require__(109);
    _this3.controller = AccessNumberValueEditorComponentController;
    return _this3;
  }

  return AccessNumberValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = AccessNumberValueEditorComponent;
AccessNumberValueEditorComponent.componentName = 'accessNumberValueEditor';
AccessNumberValueEditorComponent.valueEditorType = 'access-number';
...
AcceptableRootValueEditorComponentController.TEMPLATE_URL = __webpack_require__(126);
AcceptableRootValueEditorComponentController.TREECONTROL_TEMPLATE_URL = __webpack_require__(127);
...
var AcceptableRootValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito) {
  _inherits(AcceptableRootValueEditorComponent, _abstract_value_edito);

  var _super2 = _createSuper(AcceptableRootValueEditorComponent);

  function AcceptableRootValueEditorComponent() {
    var _this3;

    _classCallCheck(this, AcceptableRootValueEditorComponent);

    _this3 = _super2.apply(this, arguments);
    _this3.template = abstract_template_value_editor_1.default.COMPONENT_TEMPLATE;
    _this3.controller = AcceptableRootValueEditorComponentController;
    return _this3;
  }

  return AcceptableRootValueEditorComponent;
}(abstract_value_editor_component_1.default);
...
AcceptableRootValueEditorComponent.valueEditorType = 'acceptable-root';
...
var SearchTextValueEditorComponentController = /*#__PURE__*/function (_abstract_value_edito) {
  ...
  _createClass(SearchTextValueEditorComponentController, [{
    ...
    key: "$postLink",
    value: function $postLink() {
      _get(_getPrototypeOf(SearchTextValueEditorComponentController.prototype), "$postLink", this).call(this);
    ...
    value: function normalizeModel() {
      ...
      if (!equals_1.customEquals(model, this.model)) {
...
var SearchTextValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito2) {
  _inherits(SearchTextValueEditorComponent, _abstract_value_edito2);

  var _super2 = _createSuper(SearchTextValueEditorComponent);

  function SearchTextValueEditorComponent() {
    var _this2;

    _classCallCheck(this, SearchTextValueEditorComponent);

    _this2 = _super2.apply(this, arguments);
    _this2.templateUrl = __webpack_require__(132);
    _this2.controller = SearchTextValueEditorComponentController;
    return _this2;
  }

  return SearchTextValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = SearchTextValueEditorComponent;
SearchTextValueEditorComponent.componentName = 'searchTextValueEditor';
SearchTextValueEditorComponent.valueEditorType = 'search-text';
...
var SearchableValueEditorComponentController = /*#__PURE__*/function (_abstract_template_va) {
  ...
  _createClass(SearchableValueEditorComponentController, [{
    ...
    get: function get() {
      return injectables_1.isInjectable(this.options.editModelFunction) || angular.isFunction(this.options.editModelFunction);
    }
  }]);
...
SearchableValueEditorComponentController.TEMPLATE_URL = __webpack_require__(136);
/**
 * @ngdoc component
...
var SearchableValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito) {
  _inherits(SearchableValueEditorComponent, _abstract_value_edito);

  var _super2 = _createSuper(SearchableValueEditorComponent);

  function SearchableValueEditorComponent() {
    var _this4;

    _classCallCheck(this, SearchableValueEditorComponent);

    _this4 = _super2.apply(this, arguments);
    _this4.template = abstract_template_value_editor_1.default.COMPONENT_TEMPLATE;
    _this4.controller = SearchableValueEditorComponentController;
    return _this4;
  }

  return SearchableValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = SearchableValueEditorComponent;
SearchableValueEditorComponent.componentName = 'searchableValueEditor';
SearchableValueEditorComponent.valueEditorType = 'searchable';
...
RangeValueEditorComponentController.TEMPLATE_URL = __webpack_require__(143);
...
var RangeValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito) {
  _inherits(RangeValueEditorComponent, _abstract_value_edito);

  var _super2 = _createSuper(RangeValueEditorComponent);

  function RangeValueEditorComponent() {
    var _this2;

    _classCallCheck(this, RangeValueEditorComponent);

    _this2 = _super2.apply(this, arguments);
    _this2.template = abstract_template_value_editor_1.default.COMPONENT_TEMPLATE;
    _this2.controller = RangeValueEditorComponentController;
    return _this2;
  }

  return RangeValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = RangeValueEditorComponent;
RangeValueEditorComponent.componentName = 'rangeValueEditor';
RangeValueEditorComponent.valueEditorType = 'range';
...
var abstract_meta_value_editor_component_1 = __webpack_require__(39);
...
var ListValueEditorComponentController = /*#__PURE__*/function (_abstract_meta_value_) {
  ...
  _createClass(ListValueEditorComponentController, [{
    ...
    value: function $doCheck() {
      ...
      if (((_a = this.validationHelperNgModelController) === null || _a === void 0 ? void 0 : _a.$untouched) && this.hasTouchedItem()) {
    ...
    key: "canAddItem",
    value: function canAddItem() {
      var _a;

      if (!Array.isArray(this.model)) return true;
      var maxCount = (_a = this.valueEditorController.validations) === null || _a === void 0 ? void 0 : _a.maxCount;
    ...
    key: "hasTouchedItem",
    value: function hasTouchedItem() {
      var _a, _b;

      return (_b = (_a = this.form) === null || _a === void 0 ? void 0 : _a.$getControls().map(function (controller) {
        return controller.$touched;
      }).reduce(function (touched, currentTouchStatus) {
        return touched || currentTouchStatus;
      }, false)) !== null && _b !== void 0 ? _b : false;
    }
  }, {
    key: "emptyModel",
    get: function get() {
...
ListValueEditorComponentController.TEMPLATE_URL = __webpack_require__(148);
/**
 * @ngdoc component
...
var ListValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito) {
  _inherits(ListValueEditorComponent, _abstract_value_edito);

  var _super2 = _createSuper(ListValueEditorComponent);

  function ListValueEditorComponent() {
    var _this3;
    ...
    _this3 = _super2.apply(this, arguments);
    _this3.template = abstract_template_value_editor_1.default.COMPONENT_TEMPLATE;
    _this3.controller = ListValueEditorComponentController;
    return _this3;
  }

  return ListValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = ListValueEditorComponent;
ListValueEditorComponent.componentName = 'listValueEditor';
ListValueEditorComponent.valueEditorType = 'list';
...
ObjectValueEditorComponentController.TEMPLATE_URL = __webpack_require__(154);
/**
 * @ngdoc component
...
var ObjectValueEditorComponent = /*#__PURE__*/function (_abstract_value_edito) {
  _inherits(ObjectValueEditorComponent, _abstract_value_edito);

  var _super2 = _createSuper(ObjectValueEditorComponent);

  function ObjectValueEditorComponent() {
    var _this;
    ...
    _this.template = abstract_template_value_editor_1.default.COMPONENT_TEMPLATE;
    _this.controller = ObjectValueEditorComponentController;
    return _this;
  }

  return ObjectValueEditorComponent;
}(abstract_value_editor_component_1.default);

exports.default = ObjectValueEditorComponent;
ObjectValueEditorComponent.componentName = 'objectValueEditor';
ObjectValueEditorComponent.valueEditorType = 'object';
...
exports.ErrorMessagesDirectiveController = void 0;
...
var ErrorMessagesDirective = /*#__PURE__*/function () {
  ErrorMessagesDirective.$inject = ["kpValueEditorConfigurationService"];

  /*@ngInject*/
  function ErrorMessagesDirective(kpValueEditorConfigurationService) {
    _classCallCheck(this, ErrorMessagesDirective);

    this.kpValueEditorConfigurationService = kpValueEditorConfigurationService;
    this.restrict = 'A';
    this.priority = 1;
    this.require = ["".concat(ErrorMessagesDirective.directiveName), 'ngModel', "^^".concat(kp_value_editor_component_1.default.componentName)];
    this.controller = ErrorMessagesDirectiveController;
  }
  ...
  _createClass(ErrorMessagesDirective, [{
    ...
    value: function link($scope, $element, $attrs, _ref) {
      var _ref2 = _slicedToArray(_ref, 3),
          errorMessagesController = _ref2[0],
          ngModelController = _ref2[1],
          kpValueEditorController = _ref2[2];
    ...
    key: "hasRelativePositionedParent",
    value: function hasRelativePositionedParent(element) {
...
var ErrorMessagesDirectiveController = /*#__PURE__*/function () {
  ErrorMessagesDirectiveController.$inject = ["$timeout", "$attrs", "valueEditorErrorMessagesLocalizationsService"];

  /*@ngInject*/
  function ErrorMessagesDirectiveController($timeout, $attrs, valueEditorErrorMessagesLocalizationsService) {
    _classCallCheck(this, ErrorMessagesDirectiveController);
  ...
  _createClass(ErrorMessagesDirectiveController, [{
    key: "setControllers",
    value: function setControllers(kpValueEditorController, ngModelController) {
    ...
    value: function processErrors() {
      ...
      if ((this.ngModelController.$touched || ((_a = this.kpValueEditorController.valueEditorInstance.options.forceShowErrors) !== null && _a !== void 0 ? _a : false)) && getSerializedErrors(this.ngModelController.$error) !== getSerializedErrors(this.appendedElements)) {
        var errorsToRemove = arraySubtraction(Object.keys(this.appendedElements), Object.keys(this.ngModelController.$error));
        var errorsToAdd = arraySubtraction(Object.keys(this.ngModelController.$error), Object.keys(this.appendedElements));
        errorsToRemove.forEach(function (error) {
          _this.appendedElements[error].classList.add('not-visible');

          _this.$timeout(function () {
            var _a;

            (_a = _this.appendedElements[error]) === null || _a === void 0 ? void 0 : _a.remove();
            delete _this.appendedElements[error];
          }, 150);
        });
        errorsToAdd.forEach(function (error, index) {
          var _a;

          var element = angular.element(template(_templateObject(), (_a = _this.$attrs.errorMessagesCustomClass) !== null && _a !== void 0 ? _a : '', 20 * index, _this.localize(error)));
          _this.appendedElements[error] = element[0];

          _this.kpValueEditorController.$element.after(element);
  ...
  return ErrorMessagesDirectiveController;
}();

__decorate([bind_decorator_1.default], ErrorMessagesDirectiveController.prototype, "processErrors", null);

exports.ErrorMessagesDirectiveController = ErrorMessagesDirectiveController;
...
var angularjs_register_1 = __webpack_require__(0); // EDITORS


var acceptable_value_editor_module_1 = __webpack_require__(46);

var boolean_value_editor_module_1 = __webpack_require__(60);

var date_value_editor_module_1 = __webpack_require__(65);

var hidden_value_editor_module_1 = __webpack_require__(70);

var html_value_editor_module_1 = __webpack_require__(72);

var number_value_editor_module_1 = __webpack_require__(76);

var text_value_editor_module_1 = __webpack_require__(80);

var year_value_editor_module_1 = __webpack_require__(87);

var card_number_value_editor_module_1 = __webpack_require__(90);

var autocomplete_value_editor_module_1 = __webpack_require__(94);

var password_value_editor_module_1 = __webpack_require__(98);

var signature_value_editor_module_1 = __webpack_require__(104);

var access_number_value_editor_module_1 = __webpack_require__(108);

var number_range_value_editor_module_1 = __webpack_require__(112);

var exemplar_bar_code_value_editor_module_1 = __webpack_require__(118);

var acceptable_root_value_editor_module_1 = __webpack_require__(120);

var search_text_value_editor_module_1 = __webpack_require__(130);

var searchable_value_editor_module_1 = __webpack_require__(134);

var velocity_template_value_editor_module_1 = __webpack_require__(139);

var range_value_editor_module_1 = __webpack_require__(141); // META EDITORS


var list_value_editor_module_1 = __webpack_require__(146);

var object_value_editor_module_1 = __webpack_require__(152); // OTHER COMPONENTS


var kp_value_editor_component_1 = __webpack_require__(8);

var kp_value_editor_force_settings_module_1 = __webpack_require__(156);

var kp_universal_form_component_1 = __webpack_require__(19); // DIRECTIVES


var error_messages_module_1 = __webpack_require__(157);
...
var kp_async_validation_module_1 = __webpack_require__(162); // COMMON SERVICES AND PROVIDERS


var abstract_value_editor_component_controller_1 = __webpack_require__(3);

var kp_value_editor_aliases_module_1 = __webpack_require__(16);

var kp_value_editor_configuration_provider_1 = __webpack_require__(165);

var kp_value_editor_registration_provider_1 = __webpack_require__(166); // CONFIG


var value_editor_config_1 = __webpack_require__(167);
/**
 * @ngdoc constant
...
var LOADING_SPINNER_TPL_URL = __webpack_require__(169);
/**
 * @ngdoc module
...
exports.default = angularjs_register_1.default('angularjs-value-editor', ['ui.bootstrap', kp_value_editor_aliases_module_1.default, acceptable_value_editor_module_1.default, boolean_value_editor_module_1.default, date_value_editor_module_1.default, hidden_value_editor_module_1.default, html_value_editor_module_1.default, number_value_editor_module_1.default, text_value_editor_module_1.default, year_value_editor_module_1.default, card_number_value_editor_module_1.default, autocomplete_value_editor_module_1.default, password_value_editor_module_1.default, signature_value_editor_module_1.default, access_number_value_editor_module_1.default, number_range_value_editor_module_1.default, exemplar_bar_code_value_editor_module_1.default, acceptable_root_value_editor_module_1.default, search_text_value_editor_module_1.default, searchable_value_editor_module_1.default, velocity_template_value_editor_module_1.default, range_value_editor_module_1.default, list_value_editor_module_1.default, object_value_editor_module_1.default, error_messages_module_1.default, kp_value_editor_force_settings_module_1.default, kp_async_validation_module_1.default]).constant('loadingSpinnerTemplateUrl', LOADING_SPINNER_TPL_URL).config(value_editor_config_1.default).provider(abstract_value_editor_component_controller_1.EmptyConfigurationService.serviceName, abstract_value_editor_component_controller_1.EmptyConfigurationService).provider(kp_value_editor_configuration_provider_1.default.providerName, kp_value_editor_configuration_provider_1.default).provider(kp_value_editor_registration_provider_1.default.providerName, kp_value_editor_registration_provider_1.default).directive(pattern_description_tooltip_directive_1.default.directiveName, pattern_description_tooltip_directive_1.default).directive(disable_ngAnimate_directive_1.default.directiveName, disable_ngAnimate_directive_1.default).component(kp_value_editor_component_1.default.componentName, kp_value_editor_component_1.default).component(kp_universal_form_component_1.default.componentName, kp_universal_form_component_1.default).name();
/**
...
var uiSelect_decorator_1 = __webpack_require__(49);

var acceptable_value_editor_localizations_provider_1 = __webpack_require__(50);

var acceptable_value_editor_component_1 = __webpack_require__(18);

var acceptable_value_editor_configuration_provider_1 = __webpack_require__(56);

var checkboxes_validations_directive_1 = __webpack_require__(57);

var null_aware_filter_filter_1 = __webpack_require__(58);

var acceptable_value_editor_config_1 = __webpack_require__(59);
/**
 * @ngdoc module
...
var abstract_value_editor_localization_provider_1 = __webpack_require__(5);
/**
 * @ngdoc provider
...
var path = '/value-editor/editors/acceptable/templates/single-block.tpl.pug';
var html = "<div class=\"list-group\" data-main-input=\"data-main-input\"><button class=\"list-group-item\" type=\"button\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-repeat=\"$item in $ctrl.options.acceptableValues track by $index\" ng-class=\"{'active': $ctrl.isSelected($item), 'isDisabled': $ctrl.valueEditorController.isDisabled}\" ng-click=\"$ctrl.selectItem($item)\">{{optionsTemplate}}</button></div><input class=\"validation-helper\" type=\"text\" id=\"\\{\\{$ctrl.valueEditorController.editorId\\}\\}\" name=\"\\{\\{$ctrl.valueEditorController.editorName\\}\\}\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-required=\"$ctrl.valueEditorController.validations.required\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" error-messages=\"error-messages\"/>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
exports.ACCEPTABLE_VALUE_EDITOR_DEFAULT_OPTIONS = {
  ...
  equalityComparator:
  /*@ngInject*/
  ["$element1", "$element2", function equalityComparator($element1, $element2) {
    return angular.equals($element1, $element2);
  }],
  reorderable: false,
  showFirstCount: 0,
  selectedFirst: false,
...
var AcceptableValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  AcceptableValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "acceptableValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function AcceptableValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, acceptableValueEditorDefaultOptions) {
    _classCallCheck(this, AcceptableValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, acceptableValueEditorDefaultOptions);
  }
...
acceptableValueEditorConfig.$inject = ["kpValueEditorAliasesServiceProvider", "acceptableValueEditorConfigurationServiceProvider"];
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.acceptableValueEditorConfig = void 0;
var SINGLE_ACCEPTABLE_ALIAS = 'single-acceptable';
var MULTIPLE_ACCEPTABLE_ALIAS = 'multiple-acceptable';
/*@ngInject*/

function acceptableValueEditorConfig(kpValueEditorAliasesServiceProvider, acceptableValueEditorConfigurationServiceProvider) {
  kpValueEditorAliasesServiceProvider.addAlias(SINGLE_ACCEPTABLE_ALIAS, 'acceptable');
  acceptableValueEditorConfigurationServiceProvider.forAlias(SINGLE_ACCEPTABLE_ALIAS).setConfiguration({
    multiselectable: false
  });
  kpValueEditorAliasesServiceProvider.addAlias(MULTIPLE_ACCEPTABLE_ALIAS, 'acceptable');
  acceptableValueEditorConfigurationServiceProvider.forAlias(MULTIPLE_ACCEPTABLE_ALIAS).setConfiguration({
    multiselectable: true
  });
}

exports.acceptableValueEditorConfig = acceptableValueEditorConfig;
...
var boolean_value_editor_configuration_provider_1 = __webpack_require__(63);

var boolean_value_editor_component_1 = __webpack_require__(22);
/**
 * @ngdoc module
...
var BooleanValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  BooleanValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "booleanValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function BooleanValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, booleanValueEditorDefaultOptions) {
    _classCallCheck(this, BooleanValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, booleanValueEditorDefaultOptions);
  }
...
var html = "<span class=\"pretty p-icon p-smooth p-curve\" ng-class=\"{'p-has-indeterminate': $ctrl.options.nullAsIndeterminate}\"><input type=\"checkbox\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" ng-ref=\"$ctrl.inputElementModelController\" ng-ref-read=\"ngModel\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" error-messages=\"error-messages\" error-messages-custom-class=\"boolean-checkbox standalone\" data-main-input=\"data-main-input\"/><div class=\"state\"><i class=\"icon glyphicon glyphicon-ok\"></i><label></label></div><div class=\"state p-is-indeterminate\"><i class=\"icon glyphicon glyphicon-minus\"></i><label></label></div></span>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var angularjs_date_parser_1 = __webpack_require__(66);

var angularjs_bootstrap_datetimepicker_1 = __webpack_require__(67);

var angularjs_register_1 = __webpack_require__(0);

var date_value_editor_component_1 = __webpack_require__(23);

var date_value_editor_configuration_provider_1 = __webpack_require__(69);
/**
 * @ngdoc module
...
var DateValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  DateValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "dateValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function DateValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, dateValueEditorDefaultOptions) {
    _classCallCheck(this, DateValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, dateValueEditorDefaultOptions);
  }
...
var hidden_value_editor_component_1 = __webpack_require__(25);
/**
 * @ngdoc module
...
var html_value_editor_component_1 = __webpack_require__(26);

var html_value_editor_configuration_provider_1 = __webpack_require__(75);
/**
 * @ngdoc module
...
var html = "<textarea ng-attr-id=\"{{$ctrl.valueEditorController.editorId}}\" ng-attr-name=\"{{$ctrl.valueEditorController.editorName}}\" ng-attr-placeholder=\"{{$ctrl.valueEditorController.placeholder}}\" ng-ref=\"$ctrl.container\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-required=\"$ctrl.valueEditorController.validations.required\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" error-messages=\"error-messages\" data-main-input=\"data-main-input\"></textarea>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var HtmlValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  HtmlValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "htmlValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function HtmlValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, htmlValueEditorDefaultOptions) {
    _classCallCheck(this, HtmlValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, htmlValueEditorDefaultOptions);
  }
...
var number_value_editor_component_1 = __webpack_require__(27);

var number_value_editor_configuration_provider_1 = __webpack_require__(79);
/**
 * @ngdoc module
...
var html = "<input class=\"form-control {{$ctrl.options.hideSpinners ? 'hide-spinners' : ''}}\" type=\"number\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" placeholder=\"{{$ctrl.valueEditorController.placeholder}}\" step=\"{{$ctrl.options.step}}\" min=\"{{$ctrl.valueEditorController.validations.min}}\" max=\"{{$ctrl.valueEditorController.validations.max}}\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" ng-minlength=\"$ctrl.valueEditorController.validations.minlength\" ng-maxlength=\"$ctrl.valueEditorController.validations.maxlength\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" error-messages=\"error-messages\" data-main-input=\"data-main-input\"/>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var NumberValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  NumberValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "numberValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function NumberValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, numberValueEditorDefaultOptions) {
    _classCallCheck(this, NumberValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, numberValueEditorDefaultOptions);
  }
...
var text_value_editor_component_1 = __webpack_require__(13);

var text_value_editor_configuration_provider_1 = __webpack_require__(84);

var text_value_editor_localization_provider_1 = __webpack_require__(85);

var prefix_suffix_model_adder_directive_1 = __webpack_require__(86);
/**
 * @ngdoc module
...
var html = "<!-- INLINE INPUT WITH PREFIX/SUFFIX--><div class=\"input-group\" ng-if=\"$ctrl.isText() &amp;&amp; ($ctrl.options.prefix || $ctrl.options.suffix)\"><div class=\"input-group-addon prefix\" ng-show=\"$ctrl.options.prefix\">{{$ctrl.options.prefix}}</div><input class=\"form-control\" ng-if=\"$ctrl.isText()\" type=\"{{$ctrl.options.type}}\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" placeholder=\"{{$ctrl.valueEditorController.placeholder}}\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-trim=\"false\" ng-ref=\"$ctrl.preSufFixedNgModelController\" ng-ref-read=\"ngModel\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" ng-minlength=\"$ctrl.valueEditorController.validations.minlength\" ng-maxlength=\"$ctrl.valueEditorController.validations.maxlength\" ng-pattern=\"$ctrl.valueEditorController.validations.pattern\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" prefix-suffix-model-adder=\"prefix-suffix-model-adder\" pattern-description-tooltip=\"pattern-description-tooltip\" error-messages=\"error-messages\" data-main-input=\"data-main-input\" novalidate=\"novalidate\"/><div class=\"input-group-addon suffix\" ng-show=\"$ctrl.options.suffix\">{{$ctrl.options.suffix}}</div></div><!-- INLINE INPUT--><input class=\"form-control\" ng-if=\"$ctrl.isText() &amp;&amp; !($ctrl.options.prefix || $ctrl.options.suffix)\" type=\"{{$ctrl.options.type}}\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" placeholder=\"{{$ctrl.valueEditorController.placeholder}}\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-trim=\"false\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" ng-minlength=\"$ctrl.valueEditorController.validations.minlength\" ng-maxlength=\"$ctrl.valueEditorController.validations.maxlength\" ng-pattern=\"$ctrl.valueEditorController.validations.pattern\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" pattern-description-tooltip=\"pattern-description-tooltip\" error-messages=\"error-messages\" data-main-input=\"data-main-input\"/><!-- TEXTAREA--><textarea class=\"form-control\" ng-if=\"$ctrl.options.type === 'textarea'\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" placeholder=\"{{$ctrl.valueEditorController.placeholder}}\" rows=\"{{$ctrl.getNumberOfRows()}}\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-trim=\"false\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" ng-minlength=\"$ctrl.valueEditorController.validations.minlength\" ng-maxlength=\"$ctrl.valueEditorController.validations.maxlength\" ng-pattern=\"$ctrl.valueEditorController.validations.pattern\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" error-messages=\"error-messages\" data-main-input=\"data-main-input\"></textarea><!-- ACE EDITOR--><div class=\"form-control ace-editor\" ng-if=\"$ctrl.options.type === 'rich-textarea'\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" ui-ace=\"$ctrl.options.aceOptions\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" ng-trim=\"false\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" ng-minlength=\"$ctrl.valueEditorController.validations.minlength\" ng-maxlength=\"$ctrl.valueEditorController.validations.maxlength\" ng-pattern=\"$ctrl.valueEditorController.validations.pattern\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" error-messages=\"error-messages\" data-main-input=\"data-main-input\"></div>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var TextValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  TextValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "textValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function TextValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, textValueEditorDefaultOptions) {
    _classCallCheck(this, TextValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, textValueEditorDefaultOptions);
  }
...
var PrefixSuffixModelAdderDirective = /*#__PURE__*/function () {
  function PrefixSuffixModelAdderDirective() {
    _classCallCheck(this, PrefixSuffixModelAdderDirective);

    this.restrict = 'A';
    this.require = ['ngModel', "^^".concat(text_value_editor_component_1.default.componentName)];
  }

  _createClass(PrefixSuffixModelAdderDirective, [{
    key: "link",
    value: function link($scope, $element, $attrs, _ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          ngModelController = _ref2[0],
          textValueEditorController = _ref2[1];

      function trimPrefixAndSuffix(modelValue) {
        if (textValueEditorController.options.includePrefixAndSuffixToModel && typeof modelValue === 'string') {
          return modelValue.replace(new RegExp("^".concat(textValueEditorController.options.prefix)), '').replace(new RegExp("".concat(textValueEditorController.options.suffix, "$")), '');
        }

        return modelValue;
      }

      function addPrefixAndSuffix(modelValue) {
  ...
  return PrefixSuffixModelAdderDirective;
}();

exports.default = PrefixSuffixModelAdderDirective;
PrefixSuffixModelAdderDirective.directiveName = 'prefixSuffixModelAdder';
...
var year_value_editor_component_1 = __webpack_require__(28);

var year_value_editor_configuration_provider_1 = __webpack_require__(89);
/**
 * @ngdoc module
...
var html = "<kp-value-editor editor-id=\"$ctrl.valueEditorController.editorId\" editor-name=\"$ctrl.valueEditorController.editorName\" placeholder=\"$ctrl.valueEditorController.placeholder\" type=\"'date'\" ng-model=\"$ctrl.model\" ng-model-options=\"{ getterSetter: true}\" is-disabled=\"$ctrl.valueEditorController.isDisabled\" options=\"{viewFormat: 'y', maximumGranularity: 'year', forceShowErrors: $ctrl.options.forceShowErrors}\" validations=\"{minDate: $ctrl.convertYearToISO($ctrl.valueEditorController.validations.minDate), maxDate: $ctrl.convertYearToISO($ctrl.valueEditorController.validations.maxDate), required: $ctrl.valueEditorController.validations.required,async: $ctrl.valueEditorController.validations.async}\"></kp-value-editor>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var YearValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  YearValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "yearValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function YearValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, yearValueEditorDefaultOptions) {
    _classCallCheck(this, YearValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, yearValueEditorDefaultOptions);
  }
...
var card_number_value_editor_configuration_provider_1 = __webpack_require__(91);

var card_number_value_editor_localization_provider_1 = __webpack_require__(92);

var card_number_value_editor_component_1 = __webpack_require__(29);
/**
 * @ngdoc module
...
var CardNumberValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  CardNumberValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "cardNumberValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function CardNumberValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, cardNumberValueEditorDefaultOptions) {
    _classCallCheck(this, CardNumberValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, cardNumberValueEditorDefaultOptions);
  }
...
var autocomplete_value_editor_component_1 = __webpack_require__(30);

var autocomplete_value_editor_configuration_provider_1 = __webpack_require__(97);
/**
 * @ngdoc module
...
var html = "<div class=\"kp-autocomplete input-group\"><input class=\"form-control\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" placeholder=\"{{$ctrl.valueEditorController.placeholder}}\" ng-model=\"$ctrl.model\" ng-model-options=\"{getterSetter: true}\" ng-focus=\"$ctrl.fetchItemsIfNeed()\" uib-typeahead=\"item for item in $ctrl.items | filter : $viewValue\" typeahead-is-open=\"$ctrl.isOpen\" typeahead-min-length=\"$ctrl.minLength\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" error-messages=\"error-messages\" data-main-input=\"data-main-input\"/><span class=\"input-group-btn\"><button class=\"btn btn-default\" type=\"button\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-click=\"$ctrl.open()\" ng-blur=\"$ctrl.resetMinLength()\"><i class=\"glyphicon glyphicon-chevron-down\" ng-hide=\"$ctrl.loading\"></i><ng-include class=\"autocomplete-loading-svg\" src=\"$ctrl.loadingSpinnerTemplateUrl\" ng-show=\"$ctrl.loading\"></ng-include></button></span></div>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var AutocompleteValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  AutocompleteValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "autocompleteValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function AutocompleteValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, autocompleteValueEditorDefaultOptions) {
    _classCallCheck(this, AutocompleteValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, autocompleteValueEditorDefaultOptions);
  }
...
var password_value_editor_component_1 = __webpack_require__(31);

var password_value_editor_configuration_provider_1 = __webpack_require__(101);

var password_value_editor_localization_provider_1 = __webpack_require__(102);

var model_equals_directive_1 = __webpack_require__(103);
/**
 * @ngdoc module
...
var PasswordValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  PasswordValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "passwordValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function PasswordValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, passwordValueEditorDefaultOptions) {
    _classCallCheck(this, PasswordValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, passwordValueEditorDefaultOptions);
  }
...
var signature_value_editor_component_1 = __webpack_require__(32);

var signature_value_editor_configuration_provider_1 = __webpack_require__(106);

var signature_value_editor_localization_provider_1 = __webpack_require__(107);
/**
 * @ngdoc module
...
var SignatureValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  SignatureValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "signatureValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function SignatureValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, signatureValueEditorDefaultOptions) {
    _classCallCheck(this, SignatureValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, signatureValueEditorDefaultOptions);
  }
...
var access_number_value_editor_component_1 = __webpack_require__(33);

var access_number_value_editor_configuration_provider_1 = __webpack_require__(110);

var access_number_value_editor_localization_provider_1 = __webpack_require__(111);
/**
 * @ngdoc module
...
var AccessNumberValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  AccessNumberValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "accessNumberValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function AccessNumberValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, accessNumberValueEditorDefaultOptions) {
    _classCallCheck(this, AccessNumberValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, accessNumberValueEditorDefaultOptions);
  }
...
var number_range_value_editor_component_1 = __webpack_require__(15);

var number_range_value_editor_configuration_provider_1 = __webpack_require__(115);

var number_range_value_editor_localization_provider_1 = __webpack_require__(116);

var number_range_validations_directive_1 = __webpack_require__(117);
/**
 * @ngdoc module
...
exports.NUMBER_RANGE_VALUE_EDITOR_DEFAULT_OPTIONS = {
  customEmptyAsNullCheck:
  /*@ngInject*/
  ["$value", function customEmptyAsNullCheck($value) {
    return $value === undefined || $value === null || equals_1.customEquals($value, {}) || equals_1.customEquals($value, number_range_value_editor_component_1.EMPTY_MODEL);
  }]
};
/**
 * @ngdoc provider
...
var NumberRangeValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  NumberRangeValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "numberRangeValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function NumberRangeValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, numberRangeValueEditorDefaultOptions) {
    _classCallCheck(this, NumberRangeValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, numberRangeValueEditorDefaultOptions);
  }
...
var exemplar_bar_code_value_editor_config_1 = __webpack_require__(119);
/**
 * @ngdoc module
...
exemplarBarCodeValueEditorConfig.$inject = ["kpValueEditorAliasesServiceProvider", "textValueEditorConfigurationServiceProvider"];
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
function exemplarBarCodeValueEditorConfig(kpValueEditorAliasesServiceProvider, textValueEditorConfigurationServiceProvider) {
  kpValueEditorAliasesServiceProvider.addAlias(EXEMPLAR_BAR_CODE_ALIAS, 'text');
...
var angular_tree_control_1 = __webpack_require__(122);

var acceptable_root_value_editor_configuration_provider_1 = __webpack_require__(124);

var acceptable_root_value_editor_localization_provider_1 = __webpack_require__(125);

var acceptable_root_value_editor_component_1 = __webpack_require__(34);

var acceptable_root_value_editor_config_1 = __webpack_require__(128);

var acceptable_root_required_validations_directive_1 = __webpack_require__(129);
/**
 * @ngdoc module
...
var AcceptableRootValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  AcceptableRootValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "acceptableRootValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function AcceptableRootValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, acceptableRootValueEditorDefaultOptions) {
    _classCallCheck(this, AcceptableRootValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, acceptableRootValueEditorDefaultOptions);
  }
...
acceptableRootValueEditorConfig.$inject = ["kpValueEditorAliasesServiceProvider", "acceptableRootValueEditorConfigurationServiceProvider"];
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
function acceptableRootValueEditorConfig(kpValueEditorAliasesServiceProvider, acceptableRootValueEditorConfigurationServiceProvider) {
  kpValueEditorAliasesServiceProvider.addAlias(SINGLE_ACCEPTABLE_ROOT_ALIAS, 'acceptable-root');
  acceptableRootValueEditorConfigurationServiceProvider.forAlias(SINGLE_ACCEPTABLE_ROOT_ALIAS).setConfiguration({
    multiselect: false
  });
  kpValueEditorAliasesServiceProvider.addAlias(MULTIPLE_ACCEPTABLE_ROOT_ALIAS, 'acceptable-root');
...
var search_text_value_editor_localization_provider_1 = __webpack_require__(131);

var search_text_value_editor_component_1 = __webpack_require__(35);

var search_text_value_editor_configuration_provider_1 = __webpack_require__(133);
/**
 * @ngdoc module
...
var html = "<div class=\"input-group\"><div class=\"input-group-addon input-group-select\"><ui-select ng-model=\"$ctrl.extension\" ng-model-options=\"{getterSetter: true}\" search-enabled=\"false\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" disable-ng-animate=\"disable-ng-animate\" tagging=\"tagging\"><ui-select-match>{{$ctrl.localize(($ctrl.extensions | filter: $select.selected)[0])}}</ui-select-match><ui-select-choices repeat=\"$extension in $ctrl.extensions track by $extension\">{{$ctrl.localize($extension)}}</ui-select-choices></ui-select></div><input class=\"form-control\" type=\"text\" id=\"{{$ctrl.valueEditorController.editorId}}\" name=\"{{$ctrl.valueEditorController.editorName}}\" placeholder=\"{{$ctrl.valueEditorController.placeholder}}\" ng-model=\"$ctrl.row\" ng-model-options=\"{ getterSetter: true}\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-required=\"$ctrl.valueEditorController.validations.required\" ng-minlength=\"$ctrl.valueEditorController.validations.minlength\" ng-maxlength=\"$ctrl.valueEditorController.validations.maxlength\" ng-pattern=\"$ctrl.valueEditorController.validations.pattern\" kp-async-validation=\"$ctrl.valueEditorController.validations.async\" pattern-description-tooltip=\"pattern-description-tooltip\" error-messages=\"error-messages\" data-main-input=\"data-main-input\"/></div>";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
exports.SEARCH_TEXT_VALUE_EDITOR_DEFAULT_OPTIONS = {
  ...
  ["$value", function customEmptyAsNullCheck($value) {
    ...
    return ((_a = $value === null || $value === void 0 ? void 0 : $value.row) !== null && _a !== void 0 ? _a : '').length === 0;
  }]
};
/**
 * @ngdoc provider
...
var SearchTextValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  SearchTextValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "searchTextValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function SearchTextValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, searchTextValueEditorDefaultOptions) {
    _classCallCheck(this, SearchTextValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, searchTextValueEditorDefaultOptions);
  }
...
var searchable_value_editor_component_1 = __webpack_require__(36);

var searchable_value_editor_configuration_provider_1 = __webpack_require__(137);

var searchable_value_editor_localization_provider_1 = __webpack_require__(138);
/**
 * @ngdoc module
...
var SearchableValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  SearchableValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "searchableValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function SearchableValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, searchableValueEditorDefaultOptions) {
    _classCallCheck(this, SearchableValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, searchableValueEditorDefaultOptions);
  }
...
var velocity_template_value_editor_config_1 = __webpack_require__(140); // import VelocityTemplateValueEditorComponent from './velocity-template.value-editor.component';
...
velocityTemplateValueEditorConfig.$inject = ["kpValueEditorAliasesServiceProvider", "textValueEditorConfigurationServiceProvider"];
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
function velocityTemplateValueEditorConfig(kpValueEditorAliasesServiceProvider, textValueEditorConfigurationServiceProvider) {
  kpValueEditorAliasesServiceProvider.addAlias(VELOCITY_TEMPLATE_ALIAS, 'text');
...
var angularjs_histogram_slider_1 = __webpack_require__(142);

var range_value_editor_component_1 = __webpack_require__(37);

var range_value_editor_configuration_provider_1 = __webpack_require__(144);

var model_transformer_directive_1 = __webpack_require__(145);
/**
 * @ngdoc module
...
var RangeValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  RangeValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "rangeValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function RangeValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, rangeValueEditorDefaultOptions) {
    _classCallCheck(this, RangeValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, rangeValueEditorDefaultOptions);
  }
...
var list_value_editor_component_1 = __webpack_require__(38);

var list_value_editor_configuration_provider_1 = __webpack_require__(149);

var list_value_editor_localization_provider_1 = __webpack_require__(150);

var list_value_editor_validation_component_1 = __webpack_require__(151);
/**
 * @ngdoc module
...
var html = "<div class=\"panel panel-default\" id=\"{{$ctrl.valueEditorController.editorId}}\" ng-form=\"{{name}}\"><list-value-editor-validations name=\"{{name}}_required_validation_helper\" ng-model=\"$ctrl.model.length\" ng-model-options=\"{ getterSetter: true }\" ng-ref=\"$ctrl.validationHelperNgModelController\" ng-ref-read=\"ngModel\" error-messages=\"error-messages\" error-messages-custom-class=\"list\"></list-value-editor-validations><div class=\"panel-body\"><div class=\"list-item\" ng-repeat-start=\"itemModel in $ctrl.model track by $index\"><div class=\"list-item-content\" ng-class=\"{'has-error': $ctrl.showValidationError('{{name}}_' + $index), 'has-not-error': !$ctrl.showValidationError('{{name}}_' + $index)}\"><kp-value-editor editor-id=\"$index\" editor-name=\"'{{name}}_' + $index\" placeholder=\"$ctrl.valueEditorController.placeholder\" ng-model=\"$ctrl.model[$index]\" ng-model-options=\"{ getterSetter: true }\" type=\"$ctrl.options.subEditorType\" is-disabled=\"$ctrl.valueEditorController.isDisabled\" is-visible=\"$ctrl.trueIfUndefined($ctrl.valueEditorController.isVisible)\" validations=\"$ctrl.options.subEditorValidations\" options=\"$ctrl.adjustForceShowErrors($ctrl.options.subEditorOptions)\"></kp-value-editor></div><div class=\"list-item-delete-button\"><button class=\"btn btn-default remove\" type=\"button\" ng-attr-title=\"\\{\\{$ctrl.localize('remove')\\}\\}\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-show=\"$ctrl.canRemoveItems()\" ng-click=\"$ctrl.removeItem($index)\"><i class=\"glyphicon glyphicon-trash\"></i></button></div></div><hr ng-repeat-end=\"ng-repeat-end\" ng-if=\"!$last\"/></div><div class=\"panel-footer\"><button class=\"btn btn-default btn-block btn-xs add\" type=\"button\" ng-disabled=\"$ctrl.valueEditorController.isDisabled\" ng-show=\"$ctrl.canAddItem()\" ng-click=\"$ctrl.addItem()\"><i class=\"glyphicon glyphicon-plus\"></i><span ng-bind=\"$ctrl.localize('add')\"></span></button></div></div>\\{\\{$ctrl.form = {{name}}; ''\\}\\}";
window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, html) }]);
module.exports = path;
...
var ListValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  ListValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "listValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function ListValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, listValueEditorDefaultOptions) {
    _classCallCheck(this, ListValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, listValueEditorDefaultOptions);
  }
...
exports.ListValueEditorValidationsComponentController = void 0;

var kp_value_editor_component_1 = __webpack_require__(8);

var ListValueEditorValidationsComponentController = /*#__PURE__*/function () {
  function ListValueEditorValidationsComponentController() {
    _classCallCheck(this, ListValueEditorValidationsComponentController);
  }

  _createClass(ListValueEditorValidationsComponentController, [{
    key: "$onInit",
    value: function $onInit() {
      var _this = this;
      ...
      this.ngModelController.$validators['list-required'] = function (modelValue) {
        ...
        return !((_a = _this.valueEditorController.validations) === null || _a === void 0 ? void 0 : _a.required) || modelValue > 0;
      };

      this.ngModelController.$validators['max-count'] = function (modelValue) {
        var _a, _b, _c;

        return !((_a = _this.valueEditorController.validations) === null || _a === void 0 ? void 0 : _a.maxCount) || modelValue <= ((_c = (_b = _this.valueEditorController.validations) === null || _b === void 0 ? void 0 : _b.maxCount) !== null && _c !== void 0 ? _c : Number.MAX_SAFE_INTEGER);
      };
    }
  }]);

  return ListValueEditorValidationsComponentController;
}();

exports.ListValueEditorValidationsComponentController = ListValueEditorValidationsComponentController;
/**
 * @ngdoc component
...
var ListValueEditorValidationsComponent = function ListValueEditorValidationsComponent() {
  _classCallCheck(this, ListValueEditorValidationsComponent);

  this.require = {
    ngModelController: 'ngModel',
    valueEditorController: "^^".concat(kp_value_editor_component_1.default.componentName)
  };
  this.controller = ListValueEditorValidationsComponentController;
};

exports.default = ListValueEditorValidationsComponent;
ListValueEditorValidationsComponent.componentName = 'listValueEditorValidations';
...
var object_value_editor_component_1 = __webpack_require__(40);

var object_value_editor_configuration_provider_1 = __webpack_require__(155);
/**
 * @ngdoc module
...
var ObjectValueEditorConfigurationServiceProvider = /*#__PURE__*/function (_abstract_value_edito) {
  ObjectValueEditorConfigurationServiceProvider.$inject = ["kpValueEditorAliasesServiceProvider", "objectValueEditorDefaultOptions"];
  ...
  /*@ngInject*/
  function ObjectValueEditorConfigurationServiceProvider(kpValueEditorAliasesServiceProvider, objectValueEditorDefaultOptions) {
    _classCallCheck(this, ObjectValueEditorConfigurationServiceProvider);

    return _super.call(this, kpValueEditorAliasesServiceProvider, objectValueEditorDefaultOptions);
  }
...
exports.default = angularjs_register_1.default('angularjs-value-editor.force-settings').constant('DEFAULT_MERGE_STRATEGY', kp_value_editor_force_setting_component_1.DEFAULT_MERGE_STRATEGY).component(kp_value_editor_force_settings_component_1.default.componentName, kp_value_editor_force_settings_component_1.default).component(kp_value_editor_force_setting_component_1.default.componentName, kp_value_editor_force_setting_component_1.default).name();
...
var error_messages_localization_provider_1 = __webpack_require__(158);

var error_messages_directive_1 = __webpack_require__(41);
/**
 * @ngdoc module
...
var DisableNgAnimateDirective = /*#__PURE__*/function () {
  ...
  function DisableNgAnimateDirective($animate) {
    ...
    this.restrict = 'A';
    this.require = ['uiSelect', "^^".concat(kp_value_editor_component_1.default.componentName)];
  }
  ...
  _createClass(DisableNgAnimateDirective, [{
    ...
    value: function link($scope, $element, $attrs, _ref) {
      ...
      var _ref2 = _slicedToArray(_ref, 2),
          uiSelectController = _ref2[0],
          kpValueEditorComponentController = _ref2[1];

      var resolveNgAnimate = function resolveNgAnimate() {
        if (kpValueEditorComponentController.valueEditorInstance.options.__forceDisableNgAnimate) {
...
var kp_async_validation_provider_1 = __webpack_require__(163);

var kp_async_validation_directive_1 = __webpack_require__(164);
/**
 * @ngdoc module
...
exports.default = angularjs_register_1.default('angularjs-value-editor.async-validation').provider(kp_async_validation_provider_1.KpAsyncValidationServiceProvider.providerName, kp_async_validation_provider_1.KpAsyncValidationServiceProvider).directive(kp_async_validation_directive_1.default.directiveName, kp_async_validation_directive_1.default).name();
...
exports.KpAsyncValidationServiceProvider = void 0;
/**
 * @ngdoc provider
...
var KpAsyncValidationServiceProvider = /*#__PURE__*/function () {
  function KpAsyncValidationServiceProvider() {
    _classCallCheck(this, KpAsyncValidationServiceProvider);
  }

  _createClass(KpAsyncValidationServiceProvider, [{
     ...
     */
    value: function setValidationFunction(validationFunction) {
    ...
    value: function $get() {
      ...
      return {
        getValidationsFunction: function getValidationsFunction() {
          return _this.validationFunction;
        }
      };
    }
  }]);

  return KpAsyncValidationServiceProvider;
}();

exports.KpAsyncValidationServiceProvider = KpAsyncValidationServiceProvider;
KpAsyncValidationServiceProvider.providerName = 'kpAsyncValidationService';
...
var KpAsyncValidationDirective = /*#__PURE__*/function () {
  KpAsyncValidationDirective.$inject = ["$parse", "$injector", "kpAsyncValidationService", "$timeout", "valueEditorErrorMessagesLocalizationsService"];

  /*@ngInject*/
  function KpAsyncValidationDirective($parse, $injector, kpAsyncValidationService, $timeout, valueEditorErrorMessagesLocalizationsService) {
    _classCallCheck(this, KpAsyncValidationDirective);

    this.$parse = $parse;
    this.$injector = $injector;
    this.kpAsyncValidationService = kpAsyncValidationService;
    this.$timeout = $timeout;
    this.valueEditorErrorMessagesLocalizationsService = valueEditorErrorMessagesLocalizationsService;
    this.restrict = 'A';
    this.require = ["^^".concat(kp_value_editor_component_1.default.componentName), 'ngModel', "".concat(error_messages_directive_1.default.directiveName)];
  }

  _createClass(KpAsyncValidationDirective, [{
    key: "link",
    value: function link($scope, $element, $attrs, _ref) {
      var _ref2 = _slicedToArray(_ref, 3),
          valueEditorController = _ref2[0],
          ngModelController = _ref2[1],
          errorMessagesController = _ref2[2];

      var options = this.$parse($attrs[KpAsyncValidationDirective.directiveName])($scope);
    ...
    key: "validate",
    value: function validate(options, formController, errorMessagesController, ngModelController, $propertyName) {
      var _this = this;

      return function ($model) {
        return _this.$injector.invoke(_this.kpAsyncValidationService.getValidationsFunction(), null, {
          $propertyName: $propertyName,
          $model: $model,
          $formModel: (options === null || options === void 0 ? void 0 : options.sendWholeForm) ? _this.getFormModel(formController) : undefined,
          $additionalParameters: options === null || options === void 0 ? void 0 : options.additionalParameters
        }).catch(function (errorMessage) {
          _this.valueEditorErrorMessagesLocalizationsService.setLocalization('async', errorMessage);

          ngModelController.$setTouched();
          return Promise.reject(errorMessage);
        }).finally(function () {
          _this.$timeout(errorMessagesController.processErrors);
        });
      };
    }
  }, {
    key: "getFormModel",
    value: function getFormModel(formController) {
      ...
      return forms_1.getFormModel(formController);
    }
  }]);

  return KpAsyncValidationDirective;
}();

KpAsyncValidationDirective.directiveName = 'kpAsyncValidation';

__decorate([bind_decorator_1.default], KpAsyncValidationDirective.prototype, "validate", null);

exports.default = KpAsyncValidationDirective;
/**
 * @ngdoc constant
...
var ASYNC_VALIDATION_DEFAULT_OPTIONS = {
  additionalParameters: undefined,
  sendWholeForm: false
};
...
var _debugMode, _preciseWatchForOptionsChanges, _disableAutoWrapping;
...
var KpValueEditorConfigurationServiceProvider = /*#__PURE__*/function () {
  function KpValueEditorConfigurationServiceProvider() {
    ...
    _disableAutoWrapping.set(this, false);
  }
  /**
   * @ngdoc method
  ...
  _createClass(KpValueEditorConfigurationServiceProvider, [{
    ...
    value: function setPreciseWatchForOptionsChanges(preciseWatchForOptionsChanges) {
      __classPrivateFieldSet(this, _preciseWatchForOptionsChanges, preciseWatchForOptionsChanges);
    }
    /**
     * @ngdoc method
    ...
    key: "setDisableAutoWrapping",
    value: function setDisableAutoWrapping(disableAutoWrapping) {
      __classPrivateFieldSet(this, _disableAutoWrapping, disableAutoWrapping);
    }
  }, {
    key: "$get",
    value: function $get() {
      ...
      return Object.defineProperties({}, {
        ...
        disableAutoWrapping: {
          get: function get() {
            return __classPrivateFieldGet(_this, _disableAutoWrapping);
          }
        }
      });
    }
...
_debugMode = new WeakMap(), _preciseWatchForOptionsChanges = new WeakMap(), _disableAutoWrapping = new WeakMap();
...
var KpValueEditorRegistrationServiceProvider = /*#__PURE__*/function () {
  function KpValueEditorRegistrationServiceProvider() {
    _classCallCheck(this, KpValueEditorRegistrationServiceProvider);
  ...
  _createClass(KpValueEditorRegistrationServiceProvider, [{
    key: "registerEditor",
    value: function registerEditor(type, selector) {
      this.editors.forEach(function (value, key) {
        if (key === type) {
          throw new Error("Type '".concat(type, "' is already registered."));
        }

        if (value === selector) {
          throw new Error("Value editor component selector '".concat(selector, "' is already registered."));
        }
      });
    ...
    key: "$get",
    value: ["kpValueEditorAliasesService", function $get(kpValueEditorAliasesService) {
      var _this = this;
      ...
      return {
        getSelectorForType: function getSelectorForType(type) {
          ...
          if (!_this.editors.has(type)) {
            throw new Error("Unknown value editor type: '".concat(type, "'"));
          }

          return _this.editors.get(type);
        }
      };
    }]
  }]);

  return KpValueEditorRegistrationServiceProvider;
}();

exports.default = KpValueEditorRegistrationServiceProvider;
KpValueEditorRegistrationServiceProvider.providerName = 'kpValueEditorRegistrationService';
...
valueEditorsConfig.$inject = ["kpValueEditorRegistrationServiceProvider"];
Object.defineProperty(exports, "__esModule", {
  value: true
});

var string_utils_1 = __webpack_require__(168);
...
function valueEditorsConfig(kpValueEditorRegistrationServiceProvider) {
  // Core editors
  kpValueEditorRegistrationServiceProvider.registerEditor(acceptable_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(acceptable_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(acceptable_root_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(acceptable_root_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(autocomplete_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(autocomplete_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(boolean_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(boolean_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(date_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(date_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(hidden_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(hidden_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(html_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(html_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(number_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(number_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(number_range_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(number_range_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(password_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(password_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(range_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(range_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(searchable_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(searchable_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(text_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(text_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(year_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(year_value_editor_component_1.default.componentName)); // TODO: Move outside of this library - too specific editors

  kpValueEditorRegistrationServiceProvider.registerEditor(access_number_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(access_number_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(card_number_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(card_number_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(search_text_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(search_text_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(signature_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(signature_value_editor_component_1.default.componentName)); // Meta editors

  kpValueEditorRegistrationServiceProvider.registerEditor(list_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(list_value_editor_component_1.default.componentName));
  kpValueEditorRegistrationServiceProvider.registerEditor(object_value_editor_component_1.default.valueEditorType, string_utils_1.camelCaseToKebabCase(object_value_editor_component_1.default.componentName));
}

exports.default = valueEditorsConfig;
...
exports.camelCaseToKebabCaseAndRemoveBrackets = exports.camelCaseToKebabCase = void 0;
...
exports.camelCaseToKebabCaseAndRemoveBrackets = camelCaseToKebabCaseAndRemoveBrackets;
